    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/main/multiplePhotoUpload/'; 	//upload URL
...
/**	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			/**check**/
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/main/file_uploader/',	//샘플 URL입니다.
 			/**last**/
 			/**modify**/
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/resources/editor/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
